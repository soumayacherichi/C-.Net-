    ...
    public partial class DatabaseCreation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_weddingmap", x => x.MapId);
                    table.ForeignKey(
                        name: "FK_weddingmap_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_weddingmap_weddings_WeddingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_weddingmap_UserId",
                table: "weddingmap",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_weddingmap_WeddingId",
                table: "weddingmap",
                column: "WeddingId");
        }
